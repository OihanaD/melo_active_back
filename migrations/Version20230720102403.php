 ...
 */
final class Version20230720102403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coaching_session (id INT AUTO_INCREMENT NOT NULL, coach_id INT DEFAULT NULL, date_session DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, activity_session VARCHAR(255) NOT NULL, recap_of_coaching LONGTEXT DEFAULT NULL, INDEX IDX_7BAAADB43C105691 (coach_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, userclient_id INT DEFAULT NULL, usercoach_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649D7A6C841 (userclient_id), UNIQUE INDEX UNIQ_8D93D6491055A9E6 (usercoach_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
